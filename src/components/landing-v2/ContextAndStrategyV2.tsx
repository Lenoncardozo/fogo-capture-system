...
const ContextAndStrategyV2 = () => {
  return (
    <>
      <section id="contexto" className="relative">
        <div className="relative h-[48vh] md:h-[62vh] overflow-hidden">
          <img
            src={canasvieirasImg}
          ...
          <div className="absolute inset-x-0 bottom-0 max-w-7xl mx-auto px-6 lg:px-8 pb-10 md:pb-14">
          ...
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-14 lg:gap-20 items-start">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} className="space-y-8">
              ...
              <motion.div variants={fadeUp} custom={1} className="grid sm:grid-cols-2 gap-4">
                <div className="bg-secondary/35 border border-border/60 rounded-2xl p-5">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-[1.08fr_0.92fr] gap-16 items-start">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-100px' }}>
              ...
              <motion.h2 variants={fadeUp} custom={1} className="font-display text-4xl md:text-6xl font-bold leading-[0.97] mb-8 max-w-4xl">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="space-y-5">
              {audienceSignals.map((item, index) => (
                <motion.div
                  ...
                  variants={fadeUp}
                  custom={index + 3}
                  className="bg-card/70 border border-border/60 rounded-2xl p-6"
                >
      ...
      <section id="estrategia" className="py-24 md:py-32 relative overflow-hidden">
...
export default ContextAndStrategyV2;
