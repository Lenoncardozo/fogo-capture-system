  ...
  return (
    <section id="demonstracao" className="py-24 md:py-36 relative">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={4} className="mb-20">
...
export default DeliveryHybridV3;
